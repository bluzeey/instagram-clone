...
function Modal() {
    ...
    const uploadPost= async()=>{
        ...
        console.log('New doc added with the id',docRef.id)
        ...
        <Dialog 
         ...
         onClose={setOpen}>
             ...
             <Transition.Child
              ...
              pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                  <div className="">
