...
import {addDoc,collection,serverTimestamp,orderBy,query,onSnapshot,setDoc,doc,deleteDoc} from '@firebase/firestore'
...
function Post({id,username,userImg,img,caption}) {
    ...
    return (
        <div className="bg-white my-7 border rounded-sm relative">
            ...
            {comments.length > 0 && (
                <div className="ml-10 h-28 overflow-y-scroll
